    ...
    $('#result')
      .append(`
        ...
        <table style="color:#000000;font-size:10pt;font-family:Calibri;font-weight:normal;">
          <tbody>
            <tr>
              <td style="padding-right:10px">E-post:</td>
              <td style="padding-right:10px"><a href="mailto:`+ form.email +`" style="color:#000000;text-decoration:underline;">`+ form.email +`</a></td>
              <td style="padding-right:10px">Inet AB</td>
            </tr>

            <tr>
              <td style="padding-right:10px">Tel:</td>
              <td style="padding-right:10px">031 - 65 27 00</td>
              <td style="padding-right:10px">`+ stores[form.store].adress +`</td>
            </tr>

            <tr>
              <td style="padding-right:10px">Direkt:</td>
              <td style="padding-right:10px">`+ parseNumber(form.phone, 'sv', 'phone') +`</td>
              <td style="padding-right:10px">`+ stores[form.store].postal +`</td>
            </tr>

            <tr>
              <td style="padding-right:10px">Mobil:</td>
              <td style="padding-right:10px">`+ parseNumber(form.mobile, 'sv', 'mobile') +`</td>
              <td style="padding-right:10px">SVERIGE</td>
            </tr>
          </tbody>
        </table>
      `);   
        ...
        <table style="color:#000000;font-size:10pt;font-family:Calibri;font-weight:normal">
          <tbody>
            ...
            <tr>
              ...
              <td style="padding-right:10px">+46 31 65 27 00</td>
              <td style="padding-right:10px">`+ stores[form.store].adress +`</td>
            </tr>


            <tr>
              <td style="padding-right:10px">Direct:</td>
              <td style="padding-right:10px">`+ parseNumber(form.phone, 'en', 'phone') +`</td>
              <td style="padding-right:10px">`+ stores[form.store].postal +`</td>
            </tr>

            <tr>
              <td style="padding-right:10px">Mobile:</td>
              <td style="padding-right:10px">`+ parseNumber(form.mobile, 'en', 'mobile') +`</td>
              <td style="padding-right:10px">SWEDEN</td>
            </tr>
          </tbody>
        </table>
      `);
